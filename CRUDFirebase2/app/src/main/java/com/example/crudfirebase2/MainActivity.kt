...
//Jika Ada, maka akan menampilkan pesan singkan seperti berikut ini
                    Toast.makeText(
                        this@MainActivity, "Data tidak boleh ada yang kosong ", Toast.LENGTH_SHORT
                    ).show()
                } else {
/* Jika Tidak, maka data dapat diproses dan
meyimpannya pada Database Menyimpan data
                ...
                AuthUI.getInstance()
                    ...
                    .addOnCompleteListener(object : OnCompleteListener<Void> {
                        ...
                        override fun onComplete(p0: Task<Void>) {
                            Toast.makeText(
                                this@MainActivity, "Logout Berhasil ", Toast.LENGTH_SHORT
                            ).show()
                            intent = Intent(
                                applicationContext,
